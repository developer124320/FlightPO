# -*- coding: utf-8 -*-
#
# GridZoneGenerator documentation build configuration file, created by
...
latex_documents = [
  ('index', 'GridZoneGenerator.tex', u'GridZoneGenerator Documentation',
...
man_pages = [
    ('index', 'TemplateClass', u'GridZoneGenerator Documentation',
